...
class SearchQueue
{
  public:
    ...
    typedef std::function<bool(const std::pair<gls::datastructures::Vertex, double> &,
                               const std::pair<gls::datastructures::Vertex, double> &)> VertexSortingFunction;

    /// The underlying vertex queue.
    typedef std::set<std::pair<gls::datastructures::Vertex, double>, VertexSortingFunction> VertexQueue;
  ...
  private:
    ...
    bool queueComparison(const std::pair<gls::datastructures::Vertex, double> &,
